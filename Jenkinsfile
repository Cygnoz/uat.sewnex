pipeline {
    ...
    environment {
        ...
        SONARQUBE_PROJECT_KEY = 'bllbizz-sales'
        SONARQUBE_SCANNER_CREDENTIALS_ID = '6cd13a84-ffc4-412e-bfbd-6c2e12cd51e0' // Jenkins credentials ID for SonarQube token
        ECS_CLUSTER_NAME = 'dev-billbizz' // Replace with your ECS cluster name
        ECS_SERVICE_NAME = 'billbizz-sales' // Replace with your ECS service name
        ECS_TASK_DEFINITION_NAME = 'billbizz-sales' // Replace with your ECS task definition name
    }
