pipeline {
    ...
    environment {
        ...
        ECR_REPOSITORY = 'billbizz/staff'
        IMAGE_NAME = 'billbizz-staff'
        AWS_CREDENTIALS_ID = '2157424a-b8a7-45c0-90c2-bc0d407f6cea'
        AWS_ACCOUNT_ID = '654654462146' // Add your AWS account ID here
        SONARQUBE_PROJECT_KEY = 'billbizz-staff'
        SONARQUBE_SCANNER_CREDENTIALS_ID = '753585a6-79c4-47bd-aff5-a182ed7ab2a6' // Jenkins credentials ID for SonarQube token
        ECS_CLUSTER_NAME = 'dev-billbizz' // Replace with your ECS cluster name
        ECS_SERVICE_NAME = 'billbizz-staff' // Replace with your ECS service name
        ECS_TASK_DEFINITION_NAME = 'billbizz-staff' // Replace with your ECS task definition name
    }
